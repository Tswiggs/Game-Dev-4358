...
namespace AssemblyCSharp
{
	public class Player
	{
			...
			public IList<PlayerBallCreator.MONSTER_PREFABS> getTeamSelection ()
			{
					return teamSelection;
			}

			public void setTeamSelection (IList<PlayerBallCreator.MONSTER_PREFABS> teamSelection)
			{
					this.teamSelection = teamSelection;
			}

			public void addPlayerBall (PlayerBall playerBall)
			{
