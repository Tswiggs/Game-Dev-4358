Shader "Sprites/Toon" 
{
 ...
 
    {
        ...
        {
            fixed4 mainColor = (tex2D(_MainTex, IN.uv_MainTex+float2(_OutLineSpread,_OutLineSpread)) + tex2D(_MainTex, IN.uv_MainTex-float2(_OutLineSpread,_OutLineSpread))) * fixed4(0.2, 0.2, 0.2, 1);
